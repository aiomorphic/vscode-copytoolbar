...
class ToolbarManager {
    ...
    createFixedToolbar() {
        const buttons = [
            ...
            { name: 'Copy JS Structure', icon: 'json', command: constants.CMD_COPY_JS_PROJECT_STRUCTURE },
            { name: 'Copy JS Content', icon: 'json', command: constants.CMD_COPY_JS_PROJECT_CONTENT },
            { name: 'Copy Docs', icon: 'markdown', command: constants.CMD_COPY_MD_DOCS_AND_DOCSTRINGS }
        ];
